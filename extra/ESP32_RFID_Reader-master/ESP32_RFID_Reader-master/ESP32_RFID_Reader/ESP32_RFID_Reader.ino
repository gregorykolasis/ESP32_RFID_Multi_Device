...
int rfidDemod = 19; // input - demod pin from RDM6300, pullup high
int rfidClock = 18; // output - clock pin to RDM6300
...
static bool findHeader() {
  ...
  Serial.printf("No %s header found", codeStr[encodeFDX]);
  return false;
}
